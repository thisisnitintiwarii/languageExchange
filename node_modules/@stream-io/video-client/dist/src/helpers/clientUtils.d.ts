 ...
 */
export declare const createCoordinatorClient: (apiKey: string, options: StreamClientOptions | undefined) => StreamClient;
/**
 ...
 */
export declare const createTokenOrProvider: (options: StreamVideoClientOptions) => TokenOrProvider;
